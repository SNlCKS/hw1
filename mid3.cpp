...
void unitTest(double tolerance);
...
int main(int argc, char *argv[])
{
    ...
    { 
        ...
        double data[][3] = {{135.000000, 50.000000,   13.572088},
        ...
        for(int i=0; i<160; i++)
        {
            ponderal = getPonderal(data[i][0], data[i][1]);
            
            for(int j=0; j<3; j++)
                cout << setw(10) << fixed << setprecision(5) << data[i][j] << " ";
            
            cout << " " <<  ponderal;
            if(data[i][2]-ponderal > tolerance || ponderal-data[i][2] > tolerance) {
        ...
        cout << endl << endl << errors << " errors found.\nend-of-unit-test" << endl;
    }
